...
try:
    ...
    iden = os.getpid()
    with open('assets\PID.json', "w") as b:
        dic = {"PID": iden}
        json.dump(dic, b)
except:
...
def auto_login():
    ...
    join_button_locate5 = pyautogui.locateOnScreen(r'button\join_meeting.png')
    buttonx4, buttony4 = pyautogui.center(join_button_locate5)
    pyautogui.click(buttonx4, buttony4)
...
def get_time():
    ...
    """
    global csv_time, am_pm, meeting_id, set_minute, set_hour, end_time, end_set_minute, end_set_hour, end_PM_AM,passcode
    while True:
        print('Cm')
        with open('ZoomDates.csv', 'r') as file:
            ...
            for item in reader:
                ...
                try:
                    ...
                    pyautogui.alert("Problem with CSV")
                    quit()
